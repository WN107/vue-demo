...
exports.cssLoaders = function (options) {
  ...
  */
  ...
  function generateLoaders (loader, loaderOptions) {
    ...
    if (options.extract) {
      return ExtractTextPlugin.extract({
        ...
        // webpack默认会按照loaders中的加载器从右向左调用编译各种css类型文件。
        // 如果一切顺利，在loaders中的各个加载器运行结束之后就会把css文件导入到规定的文件中去
        // 如果不顺利，则继续使用vue-style-loader来处理css文件
  ...
  return {
    ...
    // sass-loader 最后的选项表明sass使用的是缩进的语法
