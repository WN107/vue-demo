...
module.exports = {
  ...
  dev: {
    ...
    // 编译发布的根目录
    assetsPublicPath: '/',
    // 需要使用proxyTabel代理的接口(可以跨域)
    proxyTable: {},

    // Various Dev Server settings
    // 开发时候的访问域名。可以通过环境变量自己设置
    host: 'localhost', // can be overwritten by process.env.HOST
    // 开发时候的端口。可以通过环境变量PORT设定。如果端口被占用，会随机分配一个未被使用的端口
    ...
    // 这个是webpack-dev-server的watchOptions的一个选项，指定webpack检查文件的方式
  ...
  build: {
    ...
    // 如果这个选项是true的话，那么则会在build后，会在浏览器中生成一份bundle报告
